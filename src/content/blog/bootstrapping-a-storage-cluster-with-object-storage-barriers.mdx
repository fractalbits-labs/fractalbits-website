...
FractalBits has the same challenge. If you are not already familiar with it, a quick look at the [architecture overview](https://github.com/fractalbits-labs/fractalbits/blob/main/docs/internals/ARCHITECTURE.md) may help. The main components referenced in this post are:
...
- [workflow.rs](https://github.com/fractalbits-labs/fractalbits/blob/main/infra/fractalbits-bootstrap/src/workflow.rs) implements the barrier layer.
- [xtask/common/src/stages.rs](https://github.com/fractalbits-labs/fractalbits/blob/main/xtask/common/src/stages.rs) defines the stage DAG.
- Service-specific modules like [root_server.rs](https://github.com/fractalbits-labs/fractalbits/blob/main/infra/fractalbits-bootstrap/src/root_server.rs), [nss_server.rs](https://github.com/fractalbits-labs/fractalbits/blob/main/infra/fractalbits-bootstrap/src/nss_server.rs), and [bss_server.rs](https://github.com/fractalbits-labs/fractalbits/blob/main/infra/fractalbits-bootstrap/src/bss_server.rs) use those barriers to coordinate.
...
The FractalBits code uses the same high-level workflow abstraction across AWS and GCP, with S3 and GCS behind a thin wrapper in [cloud_storage.rs](https://github.com/fractalbits-labs/fractalbits/blob/main/xtask/common/src/cloud_storage.rs).
...
Object storage maps cleanly onto this. Each stage is a key prefix. Dependencies are expressed by polling for the existence of upstream markers before writing your own. The stage definitions in [stages.rs](https://github.com/fractalbits-labs/fractalbits/blob/main/xtask/common/src/stages.rs) encode the DAG explicitly: each stage declares its dependencies, and the bootstrap binary enforces them at runtime by waiting on the corresponding object keys.
...
In [xtask/common/src/stages.rs](https://github.com/fractalbits-labs/fractalbits/blob/main/xtask/common/src/stages.rs), stage definitions now produce typed proofs:
