...
We built FractalBits to break out of the high-performance trap: delivering performance you can actually afford to use at scale. In our benchmarks, we achieved nearly 1M GET/s with p99 ~5ms on 4KB objects with a cluster totaling 64 cores across all data and metadata nodes. See more details in our GitHub repo README.
...
[GitHub](https://github.com/fractalbits-labs/fractalbits)

[Hackernews Discussion](https://news.ycombinator.com/item?id=46254087)
...
[3]. Amazon S3 Express One Zone now supports renaming objects within a directory bucket, https://aws.amazon.com/about-aws/whats-new/2025/06/amazon-s3-express-one-zone-atomic-renaming-objects-api/

[4]. Google Cloud Storage hierarchical namespace, https://cloud.google.com/blog/products/storage-data-transfer/cloud-storage-hierarchical-namespace-improves-aiml-checkpointing
